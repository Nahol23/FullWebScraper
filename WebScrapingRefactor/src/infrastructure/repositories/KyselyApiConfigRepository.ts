...
import type { ApiConfig, PaginationConfig } from '../../domain/entities/ApiConfig'
import { ApiParam } from '../../domain/value-objects/ApiParam'

 
export class KyselyApiConfigRepository implements IConfigRepository {
